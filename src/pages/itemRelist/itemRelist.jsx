...
const ItemRelist = () => {
  ...
  const listNFTForSale = async () => {
    await performActions(async (kit) => {
      ...
      const priceFormatted = ethers.utils
        .parseUnits(nftData.price, "ether")
        .toString();
      let transaction = await marketplace.methods
        .resellToken(id, priceFormatted)
        .send({
          from: address,
        });
    ...
    <div className="item section__padding">
      ...
      <div className="item-content">
        <div className="item-content-title">
          <h1>{nftData.name}</h1>
          <p>
            Costs <span>{nftData.price} CUSD</span> .
          </p>
        </div>
        ...
        {nftData.owner == address ? (
          ...
          >
            <div className="formGroup">
              ...
              {/*       autoFocus={true}/>*/}
              <button className="primary-btn" onClick={listNFTForSale}>
                Relist NFT
              </button>
            </div>
          </form>
          ...
          <div className="item-content-buy">
            <button className="primary-btn" onClick={purchaseNft}>
              Buy For {nftData.price} CUSD
            </button>
